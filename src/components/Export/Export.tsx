...
const greyBackgroundColor: ReactExport.ExcelStyle = {
  fill: { patternType: "solid", fgColor: { rgb: "dddddd" } },
};

const vertAlignCenter: ReactExport.ExcelStyle = {
...
const Export: FC<Props> = () => {
  ...
  const projectToExport = useAppSelector(getProjectSelector(projectId)); //=> PUSH PROJECT ID!
  ...
  function createDataSetToExport(project) {
    ...
    let fullDataArray = [
      ...
      [
        ...
        {},
        {
          value: "               Project Workload Estimation",
      ...
      [
        ...
        {
          value: exampleProject.timeBudget?.toString() + " MD",
          style: projectValueCenterStyle,
        },
      ],
      [
        //7
      ...
      [
        ...
        {
          value: exampleProject.estimationDate,
          style: projectValueCenterStyle,
        },
        { value: "Effort:", style: projectKeyStyle },
        {
          value: exampleProject.effort?.toString() + "h",
          style: projectValueCenterStyle,
        },
      ],
      [
        ...
        { value: "Date:", style: projectKeyStyle },
        {
          value: exampleProject.verificationDate,
          style: projectValueCenterStyle,
        },
      ],
      [
      ...
      [
        ...
        {
          value: "Predicted (MD)",
          style: Object.assign({}, tableHeaderCenterStyle, greyBackgroundColor),
        },
      ...
      [
        ...
        {
          value: "",
          style: Object.assign({}, borderTopStyle, greyBackgroundColor),
        }, //H
        { value: "", style: borderTopStyle },
    ...
    exampleProject.sections.forEach(function (section) {
      ...
      newArray.push({
        value: predictedMd,
        style: Object.assign({}, sectionValuesStyle, greyBackgroundColor),
      }); // H
      ...
      section.tasks.forEach(function (task) {
        ...
        newArray.push({
          value: predictedMd,
          style: Object.assign({}, taskValuesStyle, greyBackgroundColor),
        }); // H
        ...
        if (commentText) {
          ...
          commentIsImportant
            ? newArray.push({
                value: commentText,
                style: importantCommentStyle,
              })
            : newArray.push({ value: commentText, style: commentStyle }); // B
        ...
        task.subtasks.forEach(function (subtask) {
          ...
          if (commentText) {
            ...
            commentIsImportant
              ...
              : newArray.push({ value: commentText, style: commentStyle });
    ...
    newArray.push({
      value: estDeliveryDateDate,
      style: projectValueCenterSmallStyle,
    }); // F
    fullDataArray.push(newArray);
      ...
      <ExcelFile
        element={
          <button className={styles.btn}>
            <i className={`pi pi-check ${styles.icon}`}></i>Export
          </button>
        }
      >
